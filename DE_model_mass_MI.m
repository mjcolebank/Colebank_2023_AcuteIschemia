...
% This includes Myocardial infarction in the LV

function ydot = DE_model_mass_MI(t,y,pars)
% Volumes
Vsa = y(1);
Vsv = y(2);
Vra = y(3);
...
% LV
[Tm_LV,~,Gam_lv,Llv,~] = solve_wall(t,Vwall_ven(1),Am(1),Cm(1),Am_ref_ven(1),Gam(1),L(1),pars,-1);
% RV
...
[Tm_la,~,Gam_la,Lla,~] = solve_wall(t+atr_offset,Vwall(1),Am_la,Cm_la,Am_ref(1),Gam_la,Lla,pars,1);
[Tm_ra,~,Gam_ra,Lra,~] = solve_wall(t+atr_offset,Vwall(3),Am_ra,Cm_ra,Am_ref(3),Gam_ra,Lra,pars,1);
